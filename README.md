...
### 身份验证 [lib/lark/apis/authen.rb](lib/lark/apis/authen.rb)
...
### 通讯录 [lib/lark/apis/contact.rb](lib/lark/apis/contact.rb)
...
### 用户群组  [lib/lark/apis/user.rb](lib/lark/apis/user.rb)
...
### 应用管理  [lib/lark/apis/application.rb](lib/lark/apis/application.rb)
...
### 应用商店  [lib/lark/apis/pay.rb](lib/lark/apis/pay.rb)
...
### 机器人 → 群信息和群管理  [lib/lark/apis/chat.rb](lib/lark/apis/chat.rb)
...
### 机器人信息和管理  [lib/lark/apis/bot.rb](lib/lark/apis/bot.rb)
...
### 消息  [lib/lark/apis/message.rb](lib/lark/apis/message.rb)
...
### 图片  [lib/lark/apis/image.rb](lib/lark/apis/image.rb)
